...
const appRouter = t.router({
  ...
  usersRouter: t.router({
    ...
    getSuggetedUsers: publicProcedure.output(z.array(userSchema)).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
  ...
  commentsRouter: t.router({
    createComment: publicProcedure.input(createCommentSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    ...
    deleteComment: publicProcedure.input(deleteCommentSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
  }),
  storiesRouter: t.router({
    createStory: publicProcedure.input(createStorySchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
